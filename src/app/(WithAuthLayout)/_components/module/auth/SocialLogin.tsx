...
export default function SocialLogin({
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full">
      ...
      {/* Google */}
      <button className="w-full h-12 border border-[#D0D5DD] rounded-lg flex-row items-center justify-center mt-4 gap-4 flex cursor-pointer">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
        ...
        >
          <g clipPath="url(#clip0_464_20431)">
            <path
          ...
          <defs>
            <clipPath id="clip0_464_20431">
              <rect width="24" height="24" fill="white" />
            </clipPath>
          </defs>
        </svg>

        <span className="text-[16px] leading-[24px] text-[#101828] font-medium">
      ...
      <button className="w-full h-12 border border-[#D0D5DD] rounded-lg flex-row items-center justify-center mt-4 gap-4 flex cursor-pointer">
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_464_20441)">
            <path
      ...
      <div className="flex flex-row justify-center mt-6 gap-2">
        <span className="text-[14px] text-[#667085]">{title1}</span>
        <Link href={href} className="text-[14px] text-[#003087] font-semibold">
          {title2}
        </Link>
      </div>
    </div>
