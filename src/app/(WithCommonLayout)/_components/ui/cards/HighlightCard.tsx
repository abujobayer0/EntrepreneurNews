...
const HighLightCard = () => {
  return (
    <div className="w-full bg-transparent lg:bg-white">
      ...
      <div className="lg:w-[366px] lg:h-[64px] mb-3">
        <h3 className="font-semibold line-clamp-2 font-inter text-xl leading-8">
          বিল সই করতে ভারতের রাষ্ট্রপতিকেও তিন মাস সময় বেঁধে দিলেন সুপ্রিম
          কোর্ট
        </h3>
      </div>

      <div className="lg:w-[366px] h-[143px] rounded-md overflow-hidden mb-3 relative">
        <Image
      ...
      <p className="text-gray-600 font-inter text-base leading-6">
